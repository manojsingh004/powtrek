...
Route::get('/local-image-editor', 'HomeController@editor')->name('localimageeditor');
...
Route::get('verify/account/{confirmation_code}', [HomeController::class, 'getVerifyAccount'])->where('confirmation_code','[A-Za-z0-9]+');
 ...
 Route::group(['middleware' => 'auth'], function() {
	...
	Route::post('buy/now/product', [ProductsController::class, 'buy'])->middleware('auth');
...
Route::group(['middleware' => 'private.content'], function() {
	...
	Route::post('shop/add-email', [EmailMarketingController::class, 'store'])->name('email.list');
 ...
 Route::group(['middleware' => 'role'], function() {
	...
	Route::get('panel/admin/emails-marketing',[EmailMarketingController::class, 'index'])->name('members');
	...
	Route::get('panel/admin/resend/email/{id}',[AdminController::class, 'resendConfirmationEmail'])->name('members');
     ...
     Route::get('panel/admin/deposits-pix',[AdminController::class, 'deposits_pix'])->name('deposits_pix');
     Route::get('panel/admin/deposits/{id}',[AdminController::class, 'depositsView'])->name('deposits');
     Route::get('panel/admin/deposits-pix/{id}',[AdminController::class, 'depositsViewPix'])->name('deposits_pix');
     Route::post('approve/deposits',[AdminController::class, 'approveDeposits']);
     Route::post('approve/deposits-pix',[AdminController::class, 'approveDeposits_Pix']);
     Route::post('delete/deposits',[AdminController::class, 'deleteDeposits']);
	 Route::post('delete/deposits_pix',[AdminController::class, 'deleteDeposits_Pix']);
