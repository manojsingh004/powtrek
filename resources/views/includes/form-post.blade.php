        ...
        <div class="card-body pb-0">
          ...
          <span class="rounded-circle mr-3">
                ...
                <div class="media-body position-relative">
                    ...
                    <textarea class="form-control textareaAutoSize border-0 emojiArea mentions" name="description"
                              id="updateDescription" data-post-length="{{$settings->update_length}}" rows="4" cols="40"
                              placeholder="{{trans('general.write_something')}}"></textarea>
                </div>
            </div><!-- media -->
            ...
            <div class="justify-content-between align-items-center">
                ...
                <div class="form-group display-none" id="titlePost">
                    <div class="input-group mb-2">
                        ...
                        <input class="form-control" autocomplete="off" name="title" maxlength="100"
                               placeholder="{{trans('admin.title')}}" type="text">
                    </div>
                ...
                <div class="w-100">
                    ...
                    <a href="javascript:void(0)" id="removePhoto"
                       ...
                       data-placement="top" title="{{trans('general.delete')}}"><i class="fa fa-times-circle"></i></a>
                </div>
                ...
                <a href="{{url('local-image-editor')}}" target="_blank">
                    <button type="button"
                            ...
                            title="Edit And Upload Image">
                        <i class="feather icon-edit f-size-25"></i>
                    </button>
                </a>
                <button type="button"
                        ...
                        title="{{trans('general.upload_media')}} ({{ trans('general.media_type_upload') }})">
                ...
                @if ($settings->allow_zip_files)
                    ...
                    <button type="button"
                            ...
                            data-toggle="tooltip" data-placement="top" title="{{trans('general.upload_file_zip')}}"
                ...
                <button type="button" id="setPrice"
                        class="btn btn-upload btn-tooltip-form e-none align-bottom @if (auth()->user()->dark_mode == 'off') text-primary @else text-white @endif rounded-pill"
                        data-toggle="tooltip" data-placement="top" title="{{trans('general.price_post_ppv')}}">
                ...
                <button type="button" id="setTitle"
                        class="btn btn-upload btn-tooltip-form e-none align-bottom @if (auth()->user()->dark_mode == 'off') text-primary @else text-white @endif rounded-pill"
                        data-toggle="tooltip" data-placement="top" title="{{trans('general.title_post_block')}}">
              ...
              <span class="d-inline-block float-right position-relative rounded-pill w-100-mobile">
                ...
                <button type="submit" disabled
                        ...
                        data-empty="{{trans('general.empty_post')}}" data-error="{{trans('general.error')}}"
                        data-msg-error="{{trans('general.error_internet_disconnected')}}" id="btnCreateUpdate">
