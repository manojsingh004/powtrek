    ...
    <nav
        ...
        <div class="container-fluid d-flex position-relative">
            ...
            <a class="navbar-brand" href="{{url('/')}}">
                ...
                @else
                    <img
                            src="{{url('public/img', auth()->guest() && request()->path() == '/' ? $settings->logo : $settings->logo_2)}}"
            ...
            @guest
                <div>
                    <a href="/shop" class="d-lg-none">
                        <img class="btn-mobile mb-2" height="25" width="25" src="{{url('public/images/icons', 'iconbag.png')}}"
                             alt="">
                    </a>
                    <button class="pt-2 navbar-toggler @if(auth()->guest() && request()->path() == '/') text-white @endif"
            ...
            @if (auth()->check())
                <div>
                    <a href="/shop" class="d-lg-none mr-2 text-white">
                        <img class="btn-mobile" height="25" width="25" src="{{url('public/images/icons', 'iconbag.png')}}"
                             alt="">
                    </a>
                    <a href="{{url('notifications')}}" class="d-lg-none mr-5 btn-mobile position-relative"
                            ...
                            <li class="nav-item dropdown d-lg-none">
                                <a class="nav-link px-2 link-menu-mobile py-1 balance">
                                    <div>
                                        ...
                                        <span
                                                class="d-lg-none balance">{{ trans('general.balance') }}: {{Helper::amountFormatDecimal(auth()->user()->balance)}}</span>
                                    </div>
                                </a>
                            </li>
                        @endif
							...
							<i class="iconmoon icon-Dollar mr-2"></i> {{trans('general.balance')}}: {{Helper::amountFormatDecimal(auth()->user()->balance)}}
                                ...
                                <a class="dropdown-item dropdown-navbar url-user"
                                   href="{{url(auth()->User()->username)}}"><i
                                            class="feather icon-user mr-2"></i> {{ auth()->user()->verified_id == 'yes' ? trans('general.my_page') : trans('users.my_profile') }}
                                </a>
                                @if (auth()->user()->verified_id == 'yes')
                                ...
                                @if (auth()->user()->verified_id == 'yes')
                                    <a class="dropdown-item dropdown-navbar" href="{{url('my/subscribers')}}"><i
                                                class="feather icon-users mr-2"></i> {{trans('users.my_subscribers')}}
                                    </a>
                                @endif
                                <a class="dropdown-item dropdown-navbar" href="{{url('my/subscriptions')}}"><i
                                            class="feather icon-user-check mr-2"></i> {{trans('users.my_subscriptions')}}
                                </a>
                                ...
                                @if (auth()->user()->verified_id == 'no'
                                    ...
                                    <a class="dropdown-item dropdown-navbar"
                                       href="{{url('settings/verify/account')}}"><i
                                                class="feather icon-star mr-2"></i> {{trans('general.become_creator')}}
                                    </a>
                                @endif
