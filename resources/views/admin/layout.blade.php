        ...
        <div class="offcanvas-body px-0 scrollbar">
            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start list-sidebar" id="menu">
                ...
                @if (auth()->user()->hasPermission('dashboard'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin')) active @endif">
                ...
                @if (auth()->user()->hasPermission('general'))
                    <li class="nav-item">
                        <a href="#settings" data-bs-toggle="collapse"
                           class="nav-link text-truncate dropdown-toggle @if (request()->is('panel/admin/settings') ||request()->is('panel/admin/settings/limits')) active @endif"
                           @if (request()->is('panel/admin/settings') ||request()->is('panel/admin/settings/limits')) aria-expanded="true" @endif>
                            <i class="bi-gear me-2"></i> {{ __('admin.general_settings') }}
                        </a>
                    </li><!-- /end list -->
                @endif

                <div class="collapse w-100 @if (request()->is('panel/admin/settings') || request()->is('panel/admin/settings/limits')) show @endif ps-3"
                     id="settings">
                    <li>
                        <a class="nav-link text-truncate w-100 @if (request()->is('panel/admin/settings')) text-white @endif"
                           href="{{ url('panel/admin/settings') }}">
                            <i class="bi-chevron-right fs-7 me-1"></i> {{ trans('admin.general') }}
                        </a>
                    </li>
                    <li>
                        <a class="nav-link text-truncate @if (request()->is('panel/admin/settings/limits')) text-white @endif"
                           href="{{ url('panel/admin/settings/limits') }}">
                ...
                @if (auth()->user()->hasPermission('announcements'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/announcements') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/announcements')) active @endif">
                ...
                @if (auth()->user()->hasPermission('maintenance'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/maintenance/mode') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/maintenance/mode')) active @endif">
                ...
                @if (auth()->user()->hasPermission('billing'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/billing') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/billing')) active @endif">
                ...
                @if (auth()->user()->hasPermission('tax'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/tax-rates') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/tax-rates')) active @endif">
                ...
                @if (auth()->user()->hasPermission('countries_states'))
                    <li class="nav-item">
                        <a href="#countriesStates" data-bs-toggle="collapse"
                           class="nav-link text-truncate dropdown-toggle @if (request()->is('panel/admin/countries') || request()->is('panel/admin/states')) active @endif"
                           @if (request()->is('panel/admin/countries') || request()->is('panel/admin/states')) aria-expanded="true" @endif>
                            <i class="bi-globe me-2"></i> {{ __('general.countries_states') }}
                        </a>
                    </li><!-- /end list -->
                @endif

                <div class="collapse w-100 @if (request()->is('panel/admin/countries') || request()->is('panel/admin/states')) show @endif ps-3"
                     id="countriesStates">
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/countries') }}"
                           class="nav-link text-truncate w-100 @if (request()->is('panel/admin/countries')) text-white @endif">
                            <i class="bi-chevron-right fs-7 me-1"></i> {{ __('general.countries') }}
                        </a>
                    </li><!-- /end list -->
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/states') }}"
                           class="nav-link text-truncate w-100 @if (request()->is('panel/admin/states')) text-white @endif">
                ...
                @if (auth()->user()->hasPermission('email'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/settings/email') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/settings/email')) active @endif">
                ...
                @if (auth()->user()->hasPermission('live_streaming'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/live-streaming') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/live-streaming')) active @endif">
                ...
                @if (auth()->user()->hasPermission('push_notifications'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/push-notifications') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/push-notifications')) active @endif">
                ...
                @if (auth()->user()->hasPermission('stories'))
                    <li class="nav-item">
                        <a href="#stories" data-bs-toggle="collapse"
                           class="nav-link text-truncate dropdown-toggle @if (request()->is('panel/admin/stories/settings') || request()->is('panel/admin/stories/posts') || request()->is('panel/admin/stories/backgrounds')) active @endif"
                ...
                <div class="collapse w-100 @if (request()->is('panel/admin/stories/settings') || request()->is('panel/admin/stories/posts') || request()->is('panel/admin/stories/backgrounds') || request()->is('panel/admin/stories/fonts')) show @endif ps-3"
                     id="stories">
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/stories/settings') }}"
                           class="nav-link text-truncate w-100 @if (request()->is('panel/admin/stories/settings')) text-white @endif">
                            <i class="bi-chevron-right fs-7 me-1"></i> {{ __('general.settings') }}
                        </a>
                    </li><!-- /end list -->
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/stories/posts') }}"
                           class="nav-link text-truncate w-100 @if (request()->is('panel/admin/stories/posts')) text-white @endif">
                            <i class="bi-chevron-right fs-7 me-1"></i> {{ __('general.posts') }}
                        </a>
                    </li><!-- /end list -->
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/stories/backgrounds') }}"
                           class="nav-link text-truncate w-100 @if (request()->is('panel/admin/stories/backgrounds')) text-white @endif">
                            <i class="bi-chevron-right fs-7 me-1"></i> {{ __('general.backgrounds') }}
                        </a>
                    </li><!-- /end list -->
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/stories/fonts') }}"
                           class="nav-link text-truncate w-100 @if (request()->is('panel/admin/stories/fonts')) text-white @endif">
                ...
                @if (auth()->user()->hasPermission('shop'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/shop') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/shop')) active @endif">
                ...
                @if (auth()->user()->hasPermission('products'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/products') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/products')) active @endif">
                ...
                @if (auth()->user()->hasPermission('shop_categories'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/shop-categories') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/shop-categories')) active @endif">
                ...
                @if (auth()->user()->hasPermission('sales'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/sales') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/sales')) active @endif">
                ...
                @if (auth()->user()->hasPermission('storage'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/storage') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/storage')) active @endif">
                ...
                @if (auth()->user()->hasPermission('theme'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/theme') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/theme')) active @endif">
                ...
                @if (auth()->user()->hasPermission('custom_css_js'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/custom-css-js') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/custom-css-js')) active @endif">
                ...
                @if (auth()->user()->hasPermission('posts'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/posts') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/posts')) active @endif">
                ...
                @if (auth()->user()->hasPermission('subscriptions'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/subscriptions') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/subscriptions')) active @endif">
                ...
                @if (auth()->user()->hasPermission('transactions'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/transactions') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/transactions')) active @endif">
                ...
                @if (auth()->user()->hasPermission('deposits'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/deposits') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/deposits')) active @endif">
                ...
                @if (auth()->user()->hasPermission('deposits_pix'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/deposits-pix') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/deposits_pix')) active @endif">
                            <i class="bi-cash-stack me-2"></i>
                ...
                @if (auth()->user()->hasPermission('members'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/members') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/members')) active @endif">
				...
				@if (auth()->user()->hasPermission('members'))
              <li class="nav-item">
                  <a href="{{ url('panel/admin/emails-marketing') }}" class="nav-link text-truncate @if (request()->is('panel/admin/emails-marketing')) active @endif">
                      <i class="bi bi-envelope me-2"></i> E-mails Marketing
                  </a>
              </li><!-- /end list -->
              @endif
                ...
                @if (auth()->user()->hasPermission('referrals'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/referrals') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/referrals')) active @endif">
                ...
                @if (auth()->user()->hasPermission('languages'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/languages') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/languages')) active @endif">
                ...
                @if (auth()->user()->hasPermission('categories'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/categories') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/categories')) active @endif">
                ...
                @if (auth()->user()->hasPermission('reports'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/reports') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/reports')) active @endif">
                ...
                @if (auth()->user()->hasPermission('withdrawals'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/withdrawals') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/withdrawals')) active @endif">
                ...
                @if (auth()->user()->hasPermission('verification_requests'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/verification/members') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/verification/members')) active @endif">
                ...
                @if (auth()->user()->hasPermission('pages'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/pages') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/pages')) active @endif">
                ...
                @if (auth()->user()->hasPermission('blog'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/blog') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/blog')) active @endif">
                ...
                @if (auth()->user()->hasPermission('payments'))
                    <li class="nav-item">
                        <a href="#payments" data-bs-toggle="collapse"
                           class="nav-link text-truncate dropdown-toggle @if (request()->is('panel/admin/payments') || request()->is('panel/admin/payments/*')) active @endif"
                           @if (request()->is('panel/admin/payments') || request()->is('panel/admin/payments/*')) aria-expanded="true" @endif>
                            <i class="bi-credit-card me-2"></i> {{ __('admin.payment_settings') }}
                        </a>
                    </li><!-- /end list -->

                    <div class="collapse w-100 ps-3 @if (request()->is('panel/admin/payments') || request()->is('panel/admin/payments/*')) show @endif"
                         id="payments">
                        <li>
                            <a class="nav-link text-truncate @if (request()->is('panel/admin/payments')) text-white @endif"
                               href="{{ url('panel/admin/payments') }}">
                                <i class="bi-chevron-right fs-7 me-1"></i> {{ trans('admin.general') }}
                            </a>
                        </li>
                        ...
                        @foreach (PaymentGateways::all() as $key)
                            <li>
                                <a class="nav-link text-truncate @if (request()->is('panel/admin/payments/'.$key->id.'')) text-white @endif"
                                   href="{{ url('panel/admin/payments', $key->id) }}">
                ...
                @if (auth()->user()->hasPermission('profiles_social'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/profiles-social') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/profiles-social')) active @endif">
                ...
                @if (auth()->user()->hasPermission('social_login'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/social-login') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/social-login')) active @endif">
                ...
                @if (auth()->user()->hasPermission('google'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/google') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/google')) active @endif">
                ...
                @if (auth()->user()->hasPermission('pwa'))
                    <li class="nav-item">
                        <a href="{{ url('panel/admin/pwa') }}"
                           class="nav-link text-truncate @if (request()->is('panel/admin/pwa')) active @endif">
    ...
    <header class="py-3 mb-3 shadow-custom bg-white">
        ...
        <div class="container-fluid d-grid gap-3 px-4 justify-content-end position-relative">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="flex-shrink-0 dropdown">
                    <a href="#" class="d-block link-dark text-decoration-none" id="dropdownUser2"
                       data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{ Helper::getFile(config('path.avatar').auth()->user()->avatar) }}" width="32"
                ...
                <a class="ms-4 toggle-menu d-block d-lg-none text-dark fs-3 position-absolute start-0"
                   data-bs-toggle="offcanvas" data-bs-target="#sidebar-nav" href="#">
                    <i class="bi-list"></i>
                </a>
            </div>
        </div>
