				...
				<div class="row mb-3">
					...
					<option @if ($settings->payout_method_western_union == 'off') selected="selected" @endif value="off">{{ __('general.disabled') }}</option>
					  ...
					  <small class="d-block">{{ trans('general.payout_method_desc') }}</small>
							...
							<div class="row mb-3">
		          <label class="col-sm-2 col-form-labe text-lg-end">{{ __('users.payout_method') }} (Pix)</label>
		          <div class="col-sm-10">
		            <select name="payout_method_pix" class="form-select">
                  <option @if ($settings->payout_method_pix == 'on') selected="selected" @endif value="on">{{ __('general.enabled') }}</option>
                  <option @if ($settings->payout_method_pix == 'off') selected="selected" @endif value="off">{{ __('general.disabled') }}</option>
                </select>
							<small class="d-block">{{ trans('general.payout_method_desc') }}</small>
		          </div>
		        </div>
