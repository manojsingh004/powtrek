...
// Box #3 On Index
	...
	'minimum_photo_width' => 'Minimum photo width',
		...
		'pix_payment_head'=>'Pix voucher',
		'pix_transaction_id'=>'Transaction ID',
		'pix_payer' =>'Payer name',
		'info_bank_PIX'=>'Upload a screenshot of the PIX payment receipt. Make sure the data is visible',
		'pix_copied_text'=>'Copied',
		'transaction_id_error'=>'Transaction ID field must be filled',
		'pix_transfer'=>'Pix pay',
		'payer_name_error'=>'Payer name field must be filled',
		'pix_gateway_towallet'=>'Please make payment with your available wallet balance.',
